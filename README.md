...
<p align="center">
  <strong>Website sản phẩm trang trí Tết</strong>
</p>
...
Sử dụng format commit rõ ràng:

```bash
git commit -m "feat: thêm chức năng lọc sản phẩm theo giá"
git commit -m "fix: sửa lỗi đăng nhập không chuyển trang"
git commit -m "refactor: tối ưu logic tạo đơn hàng"
...
Dự án được xây dựng phục vụ mục đích học tập, thực hành quy trình phát triển phần mềm và mô phỏng một hệ thống thương mại điện tử thực tế quy mô nhỏ.
